  ...
  return (
    <div className="fixed inset-0 overflow-hidden">
      ...
      <div className="relative z-10 flex h-full w-full items-center justify-between px-12 md:px-20 lg:px-32">
        ...
        <div className="relative rounded-3xl p-10 md:p-12 lg:p-14 flex flex-col items-center gap-8 w-full max-w-md overflow-hidden">
          ...
          <div className="text-center z-10">
            ...
            <p className="text-zinc-600 text-sm">
              Sign in with X to start your arena journey
            </p>
          </div>
          ...
          <button
            onClick={login}
            className="relative cursor-pointer z-10 w-full bg-black/90 hover:bg-black text-white font-semibold py-4 px-8 rounded-full transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] text-lg shadow-lg hover:shadow-2xl flex items-center justify-center gap-2"
          >
            Connect with
          ...
          {/* Terms Text */}
          <p className="text-zinc-600 text-xs text-center leading-relaxed z-10">
