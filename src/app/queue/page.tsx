  ...
  return (
    <div className={`fixed inset-0 overflow-hidden bg-[#222732] ${aceOfSwords.variable}`}>
      ...
      <div className="relative z-10 flex flex-col h-full">
        ...
        {/* Middle Section - Tutorial Steps (always visible) */}
        <div className="flex-1 flex items-center px-8">
          {/* Tutorial Steps - Show when no champion selected */}
          {!selectedToken && (
            <div className="flex items-center justify-center gap-20 animate-fade-in w-full">
              ...
              <div className="flex flex-col items-center text-center group">
                ...
                <p className="text-white/70 text-base">Each champion</p>
                <p className="text-white/70 text-base">represents a token</p>
              </div>
              ...
              <div className="flex flex-col items-center text-center group">
                ...
                <p className="text-white/70 text-base max-w-[220px]">
                  Pay {entryFee} SOL to lock in
                </p>
                <p className="text-white/70 text-base max-w-[220px]">
                  Others can&apos;t take your champion
                </p>
              </div>
              ...
              <div className="flex flex-col items-center text-center group">
                ...
                <p className="text-white/70 text-base max-w-[220px]">
                  The token with highest
                </p>
                <p className="text-white/70 text-base max-w-[220px]">
                  bullish volatility wins
                </p>
              </div>
            </div>
          )}
